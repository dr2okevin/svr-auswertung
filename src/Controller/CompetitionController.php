...
{
    #[Route('', name: 'competitions_list', methods: ['GET'])]
    public function listCompetitions(CompetitionRepository $competitionRepository): Response
    {
        return $this->render('competition/list.html.twig', [
            'competitions' => $competitionRepository->findBy([], ['StartTime' => 'DESC']),
        ]);
    }
    ...
    #[Route('/{id}/delete', name: 'competitions_delete', methods: ['POST'])]
