...
class SeriesRepository extends ServiceEntityRepository
{
    ...
    public function findSeriesTotalsForCompetition(Competition $competition): array
    {
        $rows = $this->createQueryBuilder('series')
            ...
            ->addSelect('CASE WHEN series.FinalScoreOverride IS NOT NULL THEN series.FinalScoreOverride ELSE COALESCE(SUM(shot.value), 0) END AS totalScore')
            ...
            ->groupBy('series.id, series.FinalScoreOverride, team.id, person.id, discipline.id')
